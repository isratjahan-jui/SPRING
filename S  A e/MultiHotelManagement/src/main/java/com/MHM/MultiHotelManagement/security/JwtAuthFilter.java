...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    /**
     * Used to reject tokens issued before the user's last password change,
     * so a stolen JWT dies the moment the victim resets their password.
     */
        ...
        if (jwtUtil.isValid(token)) {
            ...
            if (
                ...
                try {
                    ...
                    LocalDateTime passwordChangedAt = userRepository.findByEmail(email)
                    ...
                    if (passwordChangedAt != null) {
                        ...
                        if (issuedAtLdt.isBefore(passwordChangedAt)) {
                            log.warn("JWT Filter - Token predates password change for: {}", email);
                            filterChain.doFilter(request, response);
                            return;
                        }
                    }
