...
public class CouponController {
    ...
    @PostMapping("/code/{code}/hotel/{hotelId}/redeem")
    public ResponseEntity<Void> redeem(@PathVariable String code, @PathVariable Long hotelId) {
        couponService.redeemCoupon(code, hotelId);
        return ResponseEntity.noContent().build();
    }
