...
public class CommissionMapper {
    ...
    // Entity → ResponseDTO
    public static CommissionResponseDTO toDTO(
        ...
        if (commission.getBooking() != null) {
            ...
            dto.setBookingTotalPrice(
                    commission.getBooking().getTotalPrice()
            );
            dto.setBookingStatus(
                    commission.getBooking().getStatus() != null
                            ? commission.getBooking().getStatus().name()
                            : null
            );
            ...
            if (commission.getBooking().getHotel() != null) {
                dto.setHotelId(
                        commission.getBooking().getHotel().getId()
                );
                dto.setHotelName(
                        commission.getBooking().getHotel().getHotelName()
                );

                // Owner info
                if (commission.getBooking()
                        .getHotel().getOwner() != null) {
                    dto.setOwnerId(commission.getBooking()
                            .getHotel().getOwner().getId());

                    if (commission.getBooking().getHotel()
                            .getOwner().getUser() != null) {
