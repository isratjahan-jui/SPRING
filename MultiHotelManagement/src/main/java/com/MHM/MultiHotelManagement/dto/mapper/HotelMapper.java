...
public class HotelMapper {
    ...
    public static HotelResponseDTO toDTO(Hotel hotel) {
        ...
        dto.setPaymentType(hotel.getPaymentType() != null ? hotel.getPaymentType().name() : null);
        dto.setAdvancePercentage(hotel.getAdvancePercentage());
        return dto;
    }
    ...
    public static Hotel toEntity(HotelRequestDTO dto) {
        ...
        if (dto.getPaymentType() != null) {
            hotel.setPaymentType(com.MHM.MultiHotelManagement.enums.PaymentType.valueOf(dto.getPaymentType()));
        }
