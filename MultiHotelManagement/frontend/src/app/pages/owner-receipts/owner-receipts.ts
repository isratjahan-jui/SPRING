  ...
  template: `
    <div class="page">
      <div class="page-header">
        <h1>Receipts</h1>
        <p class="subtitle">Payment receipts for your hotels</p>
      </div>
...
export class OwnerReceiptsComponent implements OnInit {
  receipts: Receipt[] = [];
  ...
  ngOnInit() {
    ...
    if (userId) {
      this.receiptService.getByOwnerId(userId).subscribe({
