...
@Component({
  ...
  template: `
    <div class="page">
      <div class="page-header">
        <div>
          <h1>Invoices</h1>
          <p class="subtitle">All invoices across the platform</p>
        </div>
        <div class="stats">
          <div class="stat-card">
          ...
          <tbody>
            @for (inv of invoices; track inv.id) {
              <tr>
                ...
                <td class="amount">{{ inv.taxAmount | number:'1.2-2' }}</td>
  ...
  styles: [`
    ...
    .bold { font-weight: 600; color: #e8e6e3; }
...
export class AdminInvoicesComponent implements OnInit {
  ...
  get issuedCount() { return this.invoices.filter(i => i.status === 'ISSUED').length; }
